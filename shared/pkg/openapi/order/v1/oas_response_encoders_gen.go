...
func encodeCreateOrderResponse(response *CreateOrderResponse, w http.ResponseWriter, span trace.Span) error {
...
func encodeOrderCancelByUuidResponse(response OrderCancelByUuidRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *OrderCancelByUuidNoContent:
		w.WriteHeader(204)
