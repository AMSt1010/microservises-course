				...
				case '/': // Prefix: "/"
					...
					case 'c': // Prefix: "cancel"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "POST":
								s.handleOrderCancelByUuidRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "POST")
			...
			case '/': // Prefix: "/"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "Возвращает информацию о заказе."
				...
				case '/': // Prefix: "/"
					...
					case 'c': // Prefix: "cancel"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "POST":
								r.name = OrderCancelByUuidOperation
								r.summary = "Отменяет заказ"
								r.operationID = "OrderCancelByUuid"
					...
					case 'p': // Prefix: "pay"
						...
						if len(elem) == 0 {
							...
							case "POST":
								...
								r.summary = "Проводит оплату ранее созданного заказа."
